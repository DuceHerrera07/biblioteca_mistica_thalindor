  ...
  return (
    <nav className="navbar navbar-expand-lg bg-body-tertiary">
      ...
      <div className="collapse navbar-collapse justify-content-end" id="navbarColor04">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-box-arrow-right mx-1" viewBox="0 0 16 16" style={{transform: 'translateY(-2px)'}}>
